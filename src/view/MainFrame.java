...
public class MainFrame extends JFrame {
    ...
    public MainFrame(String role) {
        ...
        btnHome.addActionListener(e -> cardLayout.show(mainPanel, "HomePanel"));
        btnEmployee.addActionListener(e -> cardLayout.show(mainPanel, "EmployeePanel"));
        btnRecruitment.addActionListener(e -> cardLayout.show(mainPanel, "RecruitmentPanel"));
        btnContract.addActionListener(e -> cardLayout.show(mainPanel, "ContractPanel")); // Sự kiện nút Hợp đồng
